...
- [Block references and heading anchors](superpowers/specs/2026-05-25-block-references-design.md) — spec — resolve `[[Note#Heading]]`, `[[Note#^block]]`, and `[text](note.md#heading)` to a destination line. Closes the "anchor navigation not implemented" gap.
