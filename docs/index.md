...
- [Finder mtime weighting](superpowers/specs/2026-05-31-finder-mtime-weighting-design.md) — demote `visitWeight` from 1.5 to 0.5 so recently modified files outrank recently visited ones at equal age.
